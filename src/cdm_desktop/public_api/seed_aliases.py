...
SEED_ALIASES: tuple[SeedAlias, ...] = (
    ...
    SeedAlias("CATL", ("300750", "SZ300750"), ("Contemporary Amperex Technology", "宁德时代"), ("CN",)),
    SeedAlias("China Merchants Bank", ("600036", "SH600036", "03968", "HK03968"), ("CMB", "招商银行"), ("CN", "HK")),
    SeedAlias("Wuliangye", ("000858", "SZ000858"), ("五粮液",), ("CN",)),
    SeedAlias("Meituan", ("03690", "HK03690"), ("美团", "Meituan Dianping"), ("HK",)),
    SeedAlias("Xiaomi", ("01810", "HK01810"), ("小米", "小米集团"), ("HK",)),
    SeedAlias("JD.com", ("JD", "09618", "HK09618"), ("京东", "京东集团"), ("HK", "US")),
    SeedAlias("Kuaishou", ("01024", "HK01024"), ("快手", "快手科技"), ("HK",)),
    SeedAlias("NetEase", ("NTES", "09999", "HK09999"), ("网易",), ("HK", "US")),
    SeedAlias("HSBC", ("HSBC", "00005", "HK00005"), ("HSBC Holdings", "汇丰", "汇丰控股"), ("HK", "US")),
    SeedAlias("ICBC", ("601398", "SH601398", "01398", "HK01398"), ("工商银行", "Industrial and Commercial Bank of China"), ("CN", "HK")),
    SeedAlias("China Construction Bank", ("601939", "SH601939", "00939", "HK00939"), ("CCB", "建设银行"), ("CN", "HK")),
